...
import com.example.gaodemap.ErrorMessage.ErrorInfo;
import com.example.gaodemap.untils.TTSController;


import java.util.ArrayList;
import java.util.List;

public class NaviBaseActivity extends AppCompatActivity implements AMapNaviViewListener,AMapNaviListener {
...
//        mAMapNavi.stopNavi();
    ...
    public void onInitNaviFailure() {
        Toast.makeText(this,"inint faile",Toast.LENGTH_SHORT).show();
    }
